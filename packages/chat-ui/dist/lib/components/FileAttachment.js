...
function FileAttachment({ onUpload, }) {
    ...
    return (react_3.default.createElement(react_3.default.Fragment, null,
        ...
        react_3.default.createElement(react_1.IconButton, { isLoading: loading, size: "lg", "aria-label": "Select Image", variant: "outline", onClick: () => hiddenFileInput.current.click(), icon: react_3.default.createElement(react_1.Icon, { w: "24px", h: "24px", as: io_1.IoMdAttach }) })));
}
