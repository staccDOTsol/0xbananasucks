...
function MintMenuItem({ mint, onClick, }) {
    ...
    return (react_2.default.createElement(react_1.MenuItem, { onClick: onClick, variant: dropdownVariant, icon: react_2.default.createElement(react_1.Center, { w: 8, h: 8, rounded: "full" },
...
const SwapForm = ({ isLoading = false, extraTransactionInfo, isSubmitting, onConnectWallet, onTradingMintsChange, onBuyBase, onSubmit, tokenBonding, pricing, base, target, ownedBase, spendCap, feeAmount, baseOptions, targetOptions, mintCap, numRemaining, showAttribution = true, swapBaseWithTargetEnabled = true, }) => {
    ...
    const unixTime = (0, hooks_1.useSolanaUnixTime)();
    const lowMint = base &&
        target &&
            ...
            react_2.default.createElement(react_1.VStack, { spacing: 4, align: "stretch" },
                react_2.default.createElement(react_1.VStack, { spacing: 1, align: "left" },
                    ...
                    react_2.default.createElement(react_1.InputGroup, { zIndex: 100, size: "lg" },
                        react_2.default.createElement(react_1.Input, Object.assign({ isInvalid: !!errors.topAmount, isDisabled: !connected, id: "topAmount", borderColor: inputBorderColor, placeholder: "0", type: "number", fontSize: "2xl", fontWeight: "semibold", step: 1 * Math.pow(10, baseMintAcc ? -baseMintAcc.decimals : -9), min: 0, _placeholder: { color: "gray.200" } }, register("topAmount", {
                ...
                react_2.default.createElement(react_1.VStack, { align: "left", spacing: 1 },
                    ...
                    react_2.default.createElement(react_1.InputGroup, { zIndex: 99, size: "lg" },
                        react_2.default.createElement(react_1.Input, Object.assign({ isInvalid: !!errors.bottomAmount, isDisabled: !connected, id: "bottomAmount", borderColor: inputBorderColor, placeholder: "0", type: "number", fontSize: "2xl", fontWeight: "semibold", step: 1 * Math.pow(10, targetMintAcc ? -targetMintAcc.decimals : -9), min: 0, _placeholder: { color: "gray.200" } }, register("bottomAmount", {
